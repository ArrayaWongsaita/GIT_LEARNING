...
import { GitPullFlowSimulator } from "@/features/remote-collaboration/components/GitPullFlowSimulator";
import {
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-6">
      <SetupGuideHeader
        ...
        title="git pull"
        description="เข้าใจว่า git pull คือการ fetch จาก Remote Repository แล้วค่อย integrate เข้ากับ local main พร้อมดูผลสุดท้ายที่สะท้อนมาถึง Working Directory ผ่าน simulator แบบ 4 stages"
      />
