...
export function GitSwitchLabAccordion({
  copyStatusByCommand,
  onCopyCommand,
}: GitSwitchLabAccordionProps) {
  return (
    <div className="mt-5 flex flex-col gap-5">
      {GIT_SWITCH_LAB_SECTIONS.map((section) => (
        <section
          key={section.id}
