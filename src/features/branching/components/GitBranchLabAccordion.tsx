...
export function GitBranchLabAccordion({
  copyStatusByCommand,
  onCopyCommand,
}: GitBranchLabAccordionProps) {
  return (
    <div className="mt-5 flex flex-col gap-5">
      {GIT_BRANCH_LAB_SECTIONS.map((section) => (
        <section
          key={section.id}
