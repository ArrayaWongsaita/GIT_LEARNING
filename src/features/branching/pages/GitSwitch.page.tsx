...
import { GitSwitchLabAccordion } from "@/features/branching/components/GitSwitchLabAccordion";
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-6">
      ...
      <section className="rounded-2xl border border-border bg-card p-4 shadow-sm md:p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          ชุด lab ด้านล่างขยายจาก flow เดิมให้ครอบคลุมทั้งการสร้าง branch, สลับกลับ branch ก่อนหน้า,
          การเช็กสถานะก่อนย้าย context และการออกจาก detached HEAD อย่างปลอดภัย
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          ถ้าต้องการทำแบบต่อเนื่อง ให้เริ่มจาก Foundation Setup &amp; First Switch แล้วไล่ลงมาจนครบทุก section
        </p>
        <GitSwitchLabAccordion
