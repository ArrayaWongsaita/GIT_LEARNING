...
import type { NestJsBasicFlowLabDifficulty, NestJsBasicFlowLabSection } from "@/features/lab/constants/basic-flow-content.constant";

type NestJsBasicFlowLabAccordionProps = {
  labSections: NestJsBasicFlowLabSection[];
  copyStatusByCommand: Record<string, CommandCopyStatus | undefined>;
  onCopyCommand: (commandKey: string, command: string) => Promise<void>;
};

const DIFFICULTY_CLASS_NAME: Record<NestJsBasicFlowLabDifficulty, string> = {
...
export function NestJsBasicFlowLabAccordion({
  labSections,
  copyStatusByCommand,
  onCopyCommand,
}: NestJsBasicFlowLabAccordionProps) {
  return (
