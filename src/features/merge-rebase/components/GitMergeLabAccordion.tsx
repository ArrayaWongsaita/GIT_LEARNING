...
export function GitMergeLabAccordion({
  copyStatusByCommand,
  onCopyCommand,
}: GitMergeLabAccordionProps) {
  return (
    <div className="mt-5 flex flex-col gap-5">
      {GIT_MERGE_LAB_SECTIONS.map((section) => (
        <section
          key={section.id}
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-2 flex flex-col gap-2">
              ...
              <p className="text-sm leading-6 text-foreground">
                <span className="font-semibold text-foreground">Config files:</span>{" "}
